...
<form action="?c=deliverycompanies&a=saveEdit" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <textarea type="text" class="form-control" id="description" name="description" style="height: 180px"></textarea>
    </div>
    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-sm-5 col-md-3">
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <input type="text" class="form-control" id="obec" placeholder="Zadaj mesto/obec" value="" name="obec" required>
                ...
                <div class="col-sm-7 col-md-5">
                    <div class="form-floating mb-3 mt-3">
                        <input type="text" class="form-control" id="ulica" placeholder="Zadaj ulicu" name="ulica" value="">
                        <label for="ulica">Ulica sídla spoločnosti</label>
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-md-2">
                    <div class="form-floating mb-3 mt-3">
                        <input type="number" class="form-control" id="zip" placeholder="Zadaj PSČ" name="zip" value="">
                        <label for="zip">PSČ spoločnosti</label>
                    </div>
                </div>
                <div class="col-6 col-sm-4 col-md-2">
                    <div class="form-floating mb-3 mt-3">
                        <input type="number" class="form-control" id="supisne-cislo" placeholder="Zadaj súpisné číslo" name="supisne-cislo" value="">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" id="photo" name="photo" value="">
    </div>
    <div class="mb-3">
        <div class="container-fluid">
            <div class="row">
                <div class="form-floating mb-3 mt-3">
                    <input type="email" class="form-control" id="email" placeholder="Zadaj email" name="email" value="">
                    <label for="email">Emailová adresa spoločnosti</label>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <input type="tel" class="form-control" id="telefon" placeholder="Zadaj telefónne číslo" name="telefon" value="">
                    <label for="telefon">Telefónne číslo spoločnosti</label>
                </div>
                <div class="form-floating mb-3 mt-3">
                    <input type="text" class="form-control" id="website" placeholder="Zadaj webstránku" name="website" value="">
